...
void UICourtOOCPresets::init()
{
	...
	u8* bgTiles = readFile("/data/ao-nds/ui/bg_oocPresets.img.bin", &bgTilesLen);
	u8* bgMap = readFile("/data/ao-nds/ui/bg_oocPresets.map.bin");
	bgPal = readFile("/data/ao-nds/ui/bg_oocPresets.pal.bin");
